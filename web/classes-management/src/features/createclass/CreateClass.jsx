...
const location =['Telangana','Andra Pradesh','Tamil Nadu','Kerala','karnataka'];
const schedule =[1,2,3,4,5,6,7,8,9];

const CreateClass =()=>{
const [classes,setClasses]= React.useState('');
const handleChange=(e)=>{setClasses(e.target.value)};
    return(<AppLayout title='Create class'>
          ...
          <AppCard minHeight={690}>
            <Grid container spacing={0}>
              ...
              <Divider
                ...
                variant="middle"
                flexItem
                sx={{ borderWidth: 1, color: "#black",mx:{md:'4.5%',lg:'5.6%',xl:'6.4%'},display:{xs:'none',sm:'none',md:'flex'}}}
              >
                OR
              </Divider>
            ...
            <Formik
              initialValues={{ fee: "", minAge: "",maxAge:"",course:"",schedule:"",classCapacity:"",classTimings:"",location:"",excludeDates:""}}
              validate={(values) => {
                let errors = {};
                if (!values.fee) {
                ...
                <form onSubmit={handleSubmit}>
                  <Grid container spacing={1} alignItems="center" sx={{marginTop:3}}>
                    <Grid item xs={12} sm={5}>
                        ...
                        errorText={errors.schedule&&touched.schedule&&errors.schedule}/></Box>
                        <Box>
                    ...
                    <AppTextInput
                        ...
                        errorText={
                          errors.classCapacity && touched.classCapacity && errors.classCapacity
                        }
                      />
                      ...
                      <AppTextInput
                        ...
                        rows={4}
                        errorText={
                          errors.classTimings && touched.classTimings && errors.classTimings
                        }
                      />
                      ...
                      <AppTextInput
                        ...
                        rows={5}
                        errorText={
                          errors.excludeDates && touched.excludeDates && errors.excludeDates
                        }
                        sx={{marginBottom:2.5}}
                      />
