...
function BoxElement({ elementOne, elementTwo, elementThree,marginTop,sm,md,lg,xl }) {
  const classes = useStyles();
  return (
    <Grid container spacing={1} sx={{marginTop:marginTop,display:{xs:'none',sm:sm,md:md,lg:lg,xl:xl} }}>
