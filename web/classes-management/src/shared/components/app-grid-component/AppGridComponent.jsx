    ...
    <section>
      <Box
        sx={{
          ...
          height: { xs: "95vh", sm: "120vh", md: "116vh", xl: "94vh" },
          // marginTop: -9,
          // width: {
          //   xs: "100%",
          //   sm: "140vh",
      ...
      >
        <Grid
          // sx={{ backgroundColor: "#e6e6e6", paddingTop: 3 }}
          container
          spacing={2}
          columns={16}
        >
          <Box
            sx={{
              // backgroundColor: "#e6e6e6",
              // marginLeft: { xs: 10, sm: 21, md: 21, lg: 21, xl: 21 },
              marginLeft: 1,
              width: "100%",
          ...
          <Grid className="About" item xs={10}>
            <Item1
              sx={{
                ...
                marginTop: { xs: 10, sm: 0, md: 0, lg: 0, xl: 0 },
                marginLeft: { xs: "-5vh", sm: 0, md: 0 },
              }}
            >
              <Typography
                sx={{
