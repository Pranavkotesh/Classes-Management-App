  ...
  return (
    <section>
      {/* <Container maxWidth="940px">
        <Box sx={{height: '95vh',backgroundColor:'whitesmoke' }} />
        <Box sx={{ flexGrow: 1 }}> */}
      ...
      <Grid sx={{backgroundColor:'#e6e6e6',paddingTop:3,paddingBottom:'50%'}} container spacing={2} columns={16}>
        ...
        <Grid className='About'item xs={12}>
          <Item sx={{width:932,height:200,marginLeft:7,paddingRight:5,borderRadius:2}}>
            <Typography sx={{fontWeight: 900,fontSize:9,textAlign:'left',marginLeft:2,paddingTop:2,paddingBottom:1,color:'black'}}>
                ...
                <div>
                <OutlinedInput sx={{width:880,height:60,marginTop:1,marginLeft:2}}/>
                </div>
                <Button variant="oulined"
                sx={{marginTop:2,marginRight:111,backgroundColor:'#1aa3ff',marginLeft:2,width:7,
        ...
        <Grid className='classInfo' item xs={12}>
          <Item sx={{marginLeft:'416px',width:932,height:90,borderRadius:2}}>
        ...
        <Grid className='classTeachers' item xs={12}>
          <Item sx={{marginLeft:'416px',width:932,height:70,borderRadius:2}}>
